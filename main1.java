...
class Street{
    ...
    public int intStart;     //Starting Intersection 
    public int intEnd;       //Ending Intersection
    public String StreetId;  //Street Name 
    public int StreetLen;     // Time on Street
...
class TakesInputFromFile extends Defined{       //Inheritance 
    Scanner inputScanner;                                                             
   ...
   public HashMap<Integer,ArrayList<Street>> map2 = new HashMap<>();
    ...
    void nextSlines(){
         for(int i=1; i<=this.NoOfStreets; i++){
            ...
            Street newstreet = new Street(IntersectionStart,IntersectionEnd,StreetName,StreetTime);   //street formation 

        
            streets.add(newstreet);   // adding the street into the street arraylist
    ...
    void nextVlines(){
        ...
        for(int i=1; i<=this.NoOfCars; i++){
            ...
            map.put(i,paths);
            map2.put(i,paths1);        // adding the newly created arraylist of streets into the hashmap 
...
class OutPutFile
{
    ...
    public int UniqueIntersections;   // Unique Intersections 
...
// check for delay   
  ...
  Download inpo = new Download();
  inpo.downloadbut(pathsvtime, streetvtime, intersectionSchedules);
